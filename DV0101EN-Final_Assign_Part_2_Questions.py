...
def update_input_container(output_container):
...
@app.callback(
    ...
    [Input(component_id='select-yewr', component_property='value'), Input(component_id='dropdown-statistics', component_property='value')])
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(figure=px.bar(average_sales,x='Vehicle_Type',y='Automobile_Sales',title='Average Number of cars sold by vehicle typw'),
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yearly_data, 
                x='Year',
                y='Automobile_Sales',
                title="Average Automobile Sales fluctuation over  non_Recession Period"))
...
#TASK 2.6: Returning the graphs for displaying Yearly data
        return [
                ...
                html.Div(className='chart-item', children=[html.Div(Y_chart3),html.Div(R_chart4)],style={'display': 'flex'})
                ]
